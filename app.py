...
def run_gemini(title, about, posts, product, key):
    ...
    try:
        ...
        resp = genai.GenerativeModel('gemini-1.5-flash').generate_content(f"Ты аналитик Telegram Ads. Продукт: '{product}'. Канал: {title}. Био: {about}. Посты: {posts}. СТРОГО JSON: {{\"score\": \"1-10\", \"verdict\": \"текст\", \"banner\": \"текст\"}}")
